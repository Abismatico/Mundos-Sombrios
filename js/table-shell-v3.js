...
(function(){
  ...
  function buildShell(screen){
    ...
    shell.addEventListener('click',async e=>{
      ...
      if(a==='director')toggleDirector(true);if(a==='director-close')toggleDirector(false);if(a==='manage')call('openManagePlayers');if(a==='shield')call('openMasterShield');if(a==='shop')call('openEquipmentShop');if(a==='forge')call('openForgeWindow');if(a==='theme')call('openThemeEditor');if(a==='hp')call('toggleNPCHealthVisibility');if(a==='leave')call('leaveVTT');if(a==='pause')await setLiveStatus('paused');if(a==='resume')await setLiveStatus('active');if(a==='notice')await sendNotice();
    });
  ...
  window.MS_TABLE_SHELL=Object.freeze({version:'2.8.6',mount,renderTelemetry,renderInitiative,setRightPane});
})();
