...
(function(){
  ...
  function updateSummary(payload){
    ...
    const stats=payload.stats||{},sum=Object.values(stats).reduce((n,v)=>n+(Number(v)||0),0),pending=[!payload.nature?'natureza':null,!payload.className?'classe':null,!payload.concept?.motivation?'motivação':null].filter(Boolean);
