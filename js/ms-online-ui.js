...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{installGuide();hookInputs();const screen=$('screen-builder');if(screen)new MutationObserver(lifecycle).observe(screen,{attributes:true,attributeFilter:['class']});setInterval(lifecycle,800)});
})();
