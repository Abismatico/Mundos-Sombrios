...
with sync_playwright() as p:
  ...
  check('Jogador não vê Núcleo PEG persistente',page.evaluate("(()=>{const e=document.getElementById('ms-evolution-orb');return !e||getComputedStyle(e).display==='none'||e.hidden})()"))
  ...
  check('Mestre vê Núcleo PEG',page.evaluate("(()=>{const e=document.getElementById('ms-evolution-orb');return !!e&&getComputedStyle(e).display!=='none'&&!e.hidden})()"))
