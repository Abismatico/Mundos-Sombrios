...
(function(){
  ...
  function installHooks(){
    ...
    const bootOrder=()=>{if(isOrder()){backupGenericPowers();renderGlory();renderPowers();}};
    if(document.readyState==='loading') document.addEventListener('DOMContentLoaded',bootOrder,{once:true});
    else bootOrder();
  }
