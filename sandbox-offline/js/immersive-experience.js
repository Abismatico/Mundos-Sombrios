...
(function(){
  ...
  function journeyStatus(){
    ...
    const cat=String(window.currentCategory||$('#char-category')?.value||'').trim(); return {concept:!!(name&&mot),category:!!cat,nature:!!nature,class:!!cls,stats:!!cls,skills:$$('#skills-list .list-item').length>0,powers:$$('#powers-list .list-item').length>0,equipment:$$('#equipment-list .list-item, #equipment-sheet-list .list-item, [data-equipment-id]').length>0,review:!!(name&&cat&&nature&&cls)};
  }
