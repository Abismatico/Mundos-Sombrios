-- Hotfix de compatibilidade: a camada de progressao pode estar ausente em
-- instalacoes que receberam apenas o schema base. A entrada na Mesa nao deve
-- cair para offline por causa dessa consulta opcional.
